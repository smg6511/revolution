...
$_lang['user_group_member_err_group_empty'] = 'Attempted to add this User to a new Group without specifying the User Group. Please review your settings under the Access Permissions tab.';
$_lang['user_group_member_err_role_empty'] = 'User Group assignments require both the Group and Role to be specified. Please select a Role for the following group(s): <em>[[+groups]]</em> (under the Access Permissions tab)';
